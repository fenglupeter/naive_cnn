...
#ifndef NAIVE_CNN_UTIL_ALIGNED_ALLOCATOR_H_
#define NAIVE_CNN_UTIL_ALIGNED_ALLOCATOR_H_

#include <stdlib.h>

#include "naive_cnn/util/nn_error.h"
...
#endif  // NAIVE_CNN_UTIL_ALIGNED_ALLOCATOR_H_
