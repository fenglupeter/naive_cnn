...
#ifndef NAIVE_CNN_OPTIMIZERS_OPTIMIZERS_H_
#define NAIVE_CNN_OPTIMIZERS_OPTIMIZERS_H_
 ...
 * usesHessian : true if an optimizer uses hessian
...
struct gradient_descent_levenberg_marquardt : public optimizer<true> {
 public:
  gradient_descent_levenberg_marquardt() : alpha(float_t(0.00085)),
  mu(float_t(0.02)) {}
  ...
  // constant to prevent step size from becoming
  // too large when H is small
  float_t mu;
};
 ...
 *
 * slightly faster than naive_cnn::momentum
 **/
...
#endif  // NAIVE_CNN_OPTIMIZERS_OPTIMIZERS_H_
